...
export default function SidebarRent() {
                        ...
                        <AccordionBody className="py-1">
                            <List className="p-0">
                                ...
                                {historyDropdownOpen && (
                                    <List>
                                        <ListItem>
                                            <i className="bi bi-card-checklist"> Xem danh sách đơn thuê</i>
                                        </ListItem>
                                        <ListItem>
                                            <i className="bi bi-eye icon-hover"> Xem người thuê nhiều nhất</i>
                                        </ListItem>
                                        <ListItem>
                                            <i className="bi bi-eye icon-hover"> Xem người thuê gần
                                                nhất</i>
                                        </ListItem>
                                    </List>
                                )}
